...
const domain = "watersoftenerofindianapolis.com";
...
export const siteConfig: SiteConfig = {
  ...
  gpgLabel: "Very Hard",
  waterSource:
    "The White River, Fall Creek, Eagle Creek Reservoir, Geist Reservoir, and Morse Reservoir, supplemented by area groundwater wells",
  waterAuthority: "Citizens Energy Group (Citizens Water)",

  // SEO
  primaryKeyword: "water softener indianapolis in",
  searchVol: 0, // open data gap — no keyword-tool access from this build
  metaDescription:
    "Professional water softener installation in Indianapolis, IN. Indianapolis tap water tests at 12-20 GPG from Citizens Energy Group. Get a free quote today.",
  ...
  zipCodes: ["46220", "46203", "46219", "46256"],
  ...
  // Business identity — edit directly, no CMS
  businessName: "Water Softener of Indianapolis",
  ...
  // Design tokens — deep navy + warm gold, distinct from the teal/orange
  // boilerplate default and from Minneapolis (teal/orange) and Tampa
  // (cobalt blue). Nods to the Indianapolis flag / Indy 500 palette.
  design: {
    primaryColor: "#1B3A6B",
    primaryLight: "#E8EEF6",
    accentColor: "#C89B3C",
